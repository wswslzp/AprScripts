...
#-----------------------------------------------------------------------------------------
# This is the foundation flow tags file.  Each flow step is a sequence of commands and
# each command has a tag associated with it and each tag has four attributes:
#-----------------------------------------------------------------------------------------
#       pre_tcl -> file to be sourced prior to the command
#      post_tcl -> file to be sourced after the command
#   replace_tcl -> file to be sourced instead of the command
#          skip -> skip the command entirely (true | false)
#-----------------------------------------------------------------------------------------
# These attributes provide more granularity that the plug-ins and are intended to
# allow for flow customization at a very detailed level.  To enable, simply uncomment
# the tag, assign the appropriate value, and make sure this file gets sourced
# from the setup.tcl or innovus_config.tcl.  Keep in mind, these tags will only
# be evaluated if the command they are associated is executed as part of the flow
#-----------------------------------------------------------------------------------------
#         verbose -> Print tag related comments for imported tags
# verbosity_level -> Print tag related comments for ALL possible tags [LOW | HIGH]
#-----------------------------------------------------------------------------------------
#set vars(feedthrough,initialize_timing,pre_tcl)            <file>
#set vars(feedthrough,initialize_timing,post_tcl)           <file>
#set vars(feedthrough,initialize_timing,replace_tcl)        <file>
#set vars(feedthrough,initialize_timing,skip)               <true or false>
#set vars(feedthrough,load_cpf,pre_tcl)                     <file>
#set vars(feedthrough,load_cpf,post_tcl)                    <file>
#set vars(feedthrough,load_cpf,replace_tcl)                 <file>
#set vars(feedthrough,load_cpf,skip)                        <true or false>
#set vars(feedthrough,commit_cpf,pre_tcl)                   <file>
#set vars(feedthrough,commit_cpf,post_tcl)                  <file>
#set vars(feedthrough,commit_cpf,replace_tcl)               <file>
#set vars(feedthrough,commit_cpf,skip)                      <true or false>
#set vars(feedthrough,run_clp_init,pre_tcl)                 <file>
#set vars(feedthrough,run_clp_init,post_tcl)                <file>
#set vars(feedthrough,run_clp_init,replace_tcl)             <file>
#set vars(feedthrough,run_clp_init,skip)                    <true or false>
#set vars(feedthrough,save_init_dbs,pre_tcl)                <file>
#set vars(feedthrough,save_init_dbs,post_tcl)               <file>
#set vars(feedthrough,save_init_dbs,replace_tcl)            <file>
#set vars(feedthrough,save_init_dbs,skip)                   <true or false>
#set vars(feedthrough,set_budgeting_mode,pre_tcl)           <file>
#set vars(feedthrough,set_budgeting_mode,post_tcl)          <file>
#set vars(feedthrough,set_budgeting_mode,replace_tcl)       <file>
#set vars(feedthrough,set_budgeting_mode,skip)              <true or false>
#set vars(feedthrough,update_constraint_mode,pre_tcl)       <file>
#set vars(feedthrough,update_constraint_mode,post_tcl)      <file>
#set vars(feedthrough,update_constraint_mode,replace_tcl)   <file>
#set vars(feedthrough,update_constraint_mode,skip)          <true or false>
#set vars(feedthrough,set_ptn_user_cns_file,pre_tcl)        <file>
#set vars(feedthrough,set_ptn_user_cns_file,post_tcl)       <file>
#set vars(feedthrough,set_ptn_user_cns_file,replace_tcl)    <file>
#set vars(feedthrough,set_ptn_user_cns_file,skip)           <true or false>
#set vars(feedthrough,set_place_mode,pre_tcl)               <file>
#set vars(feedthrough,set_place_mode,post_tcl)              <file>
#set vars(feedthrough,set_place_mode,replace_tcl)           <file>
#set vars(feedthrough,set_place_mode,skip)                  <true or false>
#set vars(feedthrough,set_proto_model,pre_tcl)              <file>
#set vars(feedthrough,set_proto_model,post_tcl)             <file>
#set vars(feedthrough,set_proto_model,replace_tcl)          <file>
#set vars(feedthrough,set_proto_model,skip)                 <true or false>
#set vars(feedthrough,place_design,pre_tcl)                 <file>
#set vars(feedthrough,place_design,post_tcl)                <file>
#set vars(feedthrough,place_design,replace_tcl)             <file>
#set vars(feedthrough,place_design,skip)                    <true or false>
#set vars(feedthrough,time_design,pre_tcl)                  <file>
#set vars(feedthrough,time_design,post_tcl)                 <file>
#set vars(feedthrough,time_design,replace_tcl)              <file>
#set vars(feedthrough,time_design,skip)                     <true or false>
#set vars(feedthrough,save_place_dbs,pre_tcl)               <file>
#set vars(feedthrough,save_place_dbs,post_tcl)              <file>
#set vars(feedthrough,save_place_dbs,replace_tcl)           <file>
#set vars(feedthrough,save_place_dbs,skip)                  <true or false>
#set vars(feedthrough,insert_ptn_feedthrough,pre_tcl)       <file>
#set vars(feedthrough,insert_ptn_feedthrough,post_tcl)      <file>
#set vars(feedthrough,insert_ptn_feedthrough,replace_tcl)   <file>
#set vars(feedthrough,insert_ptn_feedthrough,skip)          <true or false>
#set vars(feedthrough,trial_route,pre_tcl)                  <file>
#set vars(feedthrough,trial_route,post_tcl)                 <file>
#set vars(feedthrough,trial_route,replace_tcl)              <file>
#set vars(feedthrough,trial_route,skip)                     <true or false>
#set vars(feedthrough,trial_route_time_design,pre_tcl)      <file>
#set vars(feedthrough,trial_route_time_design,post_tcl)     <file>
#set vars(feedthrough,trial_route_time_design,replace_tcl)  <file>
#set vars(feedthrough,trial_route_time_design,skip)         <true or false>
# ----------------------------------------------------------------------------------------
#set vars(assign_pin,assign_ptn_pins,pre_tcl)               <file>
#set vars(assign_pin,assign_ptn_pins,post_tcl)              <file>
#set vars(assign_pin,assign_ptn_pins,replace_tcl)           <file>
#set vars(assign_pin,assign_ptn_pins,skip)                  <true or false>
#set vars(assign_pin,check_pin_assignment,pre_tcl)          <file>
#set vars(assign_pin,check_pin_assignment,post_tcl)         <file>
#set vars(assign_pin,check_pin_assignment,replace_tcl)      <file>
#set vars(assign_pin,check_pin_assignment,skip)             <true or false>
#set vars(assign_pin,report_unaligned_nets,pre_tcl)         <file>
#set vars(assign_pin,report_unaligned_nets,post_tcl)        <file>
#set vars(assign_pin,report_unaligned_nets,replace_tcl)     <file>
#set vars(assign_pin,report_unaligned_nets,skip)            <true or false>
#set vars(assign_pin,trial_route,pre_tcl)                   <file>
#set vars(assign_pin,trial_route,post_tcl)                  <file>
#set vars(assign_pin,trial_route,replace_tcl)               <file>
#set vars(assign_pin,trial_route,skip)                      <true or false>
# ----------------------------------------------------------------------------------------
#set vars(model_gen,create_ps_per_micron_model,pre_tcl)     <file>
#set vars(model_gen,create_ps_per_micron_model,post_tcl)    <file>
#set vars(model_gen,create_ps_per_micron_model,replace_tcl) <file>
#set vars(model_gen,create_ps_per_micron_model,skip)        <true or false>
#set vars(model_gen,identify_proto_model,pre_tcl)           <file>
#set vars(model_gen,identify_proto_model,post_tcl)          <file>
#set vars(model_gen,identify_proto_model,replace_tcl)       <file>
#set vars(model_gen,identify_proto_model,skip)              <true or false>
#set vars(model_gen,report_proto_model,pre_tcl)             <file>
#set vars(model_gen,report_proto_model,post_tcl)            <file>
#set vars(model_gen,report_proto_model,replace_tcl)         <file>
#set vars(model_gen,report_proto_model,skip)                <true or false>
#set vars(model_gen,setIlmMode,pre_tcl)                     <file>
#set vars(model_gen,setIlmMode,post_tcl)                    <file>
#set vars(model_gen,setIlmMode,replace_tcl)                 <file>
#set vars(model_gen,setIlmMode,skip)                        <true or false>
#set vars(model_gen,create_proto_model,pre_tcl)             <file>
#set vars(model_gen,create_proto_model,post_tcl)            <file>
#set vars(model_gen,create_proto_model,replace_tcl)         <file>
#set vars(model_gen,create_proto_model,skip)                <true or false>
#set vars(model_gen,create_flexfiller_route_blockage,pre_tcl)<file>
#set vars(model_gen,create_flexfiller_route_blockage,post_tcl)<file>
#set vars(model_gen,create_flexfiller_route_blockage,replace_tcl)<file>
#set vars(model_gen,create_flexfiller_route_blockage,skip)  <true or false>
#set vars(model_gen,report_proto_model,pre_tcl)             <file>
#set vars(model_gen,report_proto_model,post_tcl)            <file>
#set vars(model_gen,report_proto_model,replace_tcl)         <file>
#set vars(model_gen,report_proto_model,skip)                <true or false>
#set vars(model_gen,saveDesign,pre_tcl)                     <file>
#set vars(model_gen,saveDesign,post_tcl)                    <file>
#set vars(model_gen,saveDesign,replace_tcl)                 <file>
#set vars(model_gen,saveDesign,skip)                        <true or false>
# ----------------------------------------------------------------------------------------
#set vars(partition,time_design_proto,pre_tcl)              <file>
#set vars(partition,time_design_proto,post_tcl)             <file>
#set vars(partition,time_design_proto,replace_tcl)          <file>
#set vars(partition,time_design_proto,skip)                 <true or false>
#set vars(partition,set_pspm_vars,pre_tcl)                  <file>
#set vars(partition,set_pspm_vars,post_tcl)                 <file>
#set vars(partition,set_pspm_vars,replace_tcl)              <file>
#set vars(partition,set_pspm_vars,skip)                     <true or false>
...
#set vars(init,ff_replace_flexmodel_with_full_netlist,pre_tcl)<file>
#set vars(init,ff_replace_flexmodel_with_full_netlist,post_tcl)<file>
#set vars(init,ff_replace_flexmodel_with_full_netlist,replace_tcl)<file>
#set vars(init,ff_replace_flexmodel_with_full_netlist,skip) <true or false>
# ----------------------------------------------------------------------------------------
...
#set vars(place,place_opt_design,pre_tcl)                   <file>
#set vars(place,place_opt_design,post_tcl)                  <file>
#set vars(place,place_opt_design,replace_tcl)               <file>
#set vars(place,place_opt_design,skip)                      <true or false>
...
#set vars(cts,cleanup_specify_clock_tree,pre_tcl)           <file>
#set vars(cts,cleanup_specify_clock_tree,post_tcl)          <file>
#set vars(cts,cleanup_specify_clock_tree,replace_tcl)       <file>
#set vars(cts,cleanup_specify_clock_tree,skip)              <true or false>
...
#set vars(cts,specify_clock_tree,pre_tcl)                   <file>
#set vars(cts,specify_clock_tree,post_tcl)                  <file>
#set vars(cts,specify_clock_tree,replace_tcl)               <file>
#set vars(cts,specify_clock_tree,skip)                      <true or false>
...
#set vars(signoff,signoff_time_design,pre_tcl)              <file>
#set vars(signoff,signoff_time_design,post_tcl)             <file>
#set vars(signoff,signoff_time_design,replace_tcl)          <file>
#set vars(signoff,signoff_time_design,skip)                 <true or false>
...
#set vars(assemble,pre_signoff_eco_verify_connectivity,pre_tcl)<file>
#set vars(assemble,pre_signoff_eco_verify_connectivity,post_tcl)<file>
#set vars(assemble,pre_signoff_eco_verify_connectivity,replace_tcl)<file>
#set vars(assemble,pre_signoff_eco_verify_connectivity,skip)<true or false>
#set vars(assemble,pre_signoff_eco_verify_geometry,pre_tcl) <file>
#set vars(assemble,pre_signoff_eco_verify_geometry,post_tcl)<file>
#set vars(assemble,pre_signoff_eco_verify_geometry,replace_tcl)<file>
#set vars(assemble,pre_signoff_eco_verify_geometry,skip)    <true or false>
...
#set vars(assemble,extract_rc,pre_tcl)                      <file>
#set vars(assemble,extract_rc,post_tcl)                     <file>
#set vars(assemble,extract_rc,replace_tcl)                  <file>
#set vars(assemble,extract_rc,skip)                         <true or false>
#set vars(assemble,signoff_opt_design,pre_tcl)              <file>
#set vars(assemble,signoff_opt_design,post_tcl)             <file>
#set vars(assemble,signoff_opt_design,replace_tcl)          <file>
#set vars(assemble,signoff_opt_design,skip)                 <true or false>
#set vars(assemble,signoff_time_design,pre_tcl)             <file>
#set vars(assemble,signoff_time_design,post_tcl)            <file>
#set vars(assemble,signoff_time_design,replace_tcl)         <file>
#set vars(assemble,signoff_time_design,skip)                <true or false>
...
#set vars(assemble,eco_route,pre_tcl)                       <file>
#set vars(assemble,eco_route,post_tcl)                      <file>
#set vars(assemble,eco_route,replace_tcl)                   <file>
#set vars(assemble,eco_route,skip)                          <true or false>
#set vars(assemble,post_signoff_eco_verify_connectivity,pre_tcl)<file>
#set vars(assemble,post_signoff_eco_verify_connectivity,post_tcl)<file>
#set vars(assemble,post_signoff_eco_verify_connectivity,replace_tcl)<file>
#set vars(assemble,post_signoff_eco_verify_connectivity,skip)<true or false>
#set vars(assemble,post_signoff_eco_verify_geometry,pre_tcl)<file>
#set vars(assemble,post_signoff_eco_verify_geometry,post_tcl)<file>
#set vars(assemble,post_signoff_eco_verify_geometry,replace_tcl)<file>
#set vars(assemble,post_signoff_eco_verify_geometry,skip)   <true or false>
# ----------------------------------------------------------------------------------------
